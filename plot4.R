...
#### PLOT 1
with(house_power_subset2, plot(DateTime, as.numeric(as.character(house_power_subset2$Global_active_power)),type="n",xlab="DateTime",ylab=""))
lines(house_power_subset2$DateTime, as.numeric(as.character(house_power_subset2$Global_active_power)))
title(main="Global Active Power usage by time of day", sub="", 
      ylab="Global Active Power (Kilowatts)")

#### PLOT 2 
with(house_power_subset2, plot(DateTime, as.numeric(as.character(Voltage)),type="n", xlab="DateTime", ylab="Voltage"))
lines(house_power_subset2$DateTime, as.numeric(as.character(house_power_subset2$Voltage)))


#### PLOT 3 
with(house_power_subset2, plot(DateTime, as.numeric(as.character(Sub_metering_1)),type="n", xlab="DateTime", ylab=""))
...
#### PLOT 4 
with(house_power_subset2, plot(DateTime, as.numeric(as.character(Global_reactive_power)),type="n", xlab="DateTime", ylab="Global Reactive Power"))
lines(house_power_subset2$DateTime, as.numeric(as.character(house_power_subset2$Global_reactive_power)))
